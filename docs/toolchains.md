...
**2. Let the session reach PyPI.** The [shipped allow-list](../SECURITY.md#what-a-session-may-reach) carries
...
pool](../SECURITY.md#one-account-per-concurrent-session) exists to prevent. Each directory is `1770`, owner
...
[the allow-list](../SECURITY.md#what-a-session-may-reach): the runtime ships in the image, and a repository
