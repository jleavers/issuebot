...
the seal alone, from the hook line or
[`.issuebot/env`](#issuebotenv-what-a-hook-hands-the-agent) and with no change to issuebot,
and the per-workspace cache for the channel entire.
